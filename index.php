...
$cats[-1] = ["category_id" => "All", "category_name" => "All...", "category_description" => "None"];
            ...
            <div class="row g-0 gx-5 align-items-end">
                ...
                <div class="col-lg-6 text-start text-lg-end wow slideInRight" data-wow-delay="0.1s">
                    <ul class="nav nav-pills d-inline-flex justify-content-end mb-5">
                        <?php foreach ($cats as $this_cat) : { ?>

                                <li class="nav-item me-2">
                                    <a class="btn btn-outline-primary border-2" data-bs-toggle="pill" href="#tab-<?php echo $this_cat["category_id"] ?>"><?php echo $this_cat["category_name"] ?></a>
                                </li>
                        <?php }
                        endforeach; ?>
                    </ul>
            ...
            <div class="tab-content">
                <?php foreach ($cats as $cat) : { ?>
                        ...
                        if ($cat["category_id"] == 'All') {
                            ...
                            $stmt = $pdo->prepare("SELECT * FROM products WHERE product_category_id=:cat");
                            $stmt->bindValue(":cat", $cat["category_id"]);
                        }
                        $stmt->execute();
                        $products = $stmt->fetchAll(PDO::FETCH_ASSOC);

                        if ($this_cat["category_id"] == $cat["category_id"]) {
                            $active = 'active';
                        } else {
                            $active = '';
                        }
                        ?>
                        <div id="tab-<?php echo $cat["category_id"] ?>" class="tab-pane fade show p-0 <?php echo $active ?>">
                            <div class="row g-4">
