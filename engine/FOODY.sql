...
CREATE TABLE pickup_point(
    ...
    FOREIGN KEY(pickup_point_product_order_id) REFERENCES product_order(product_order_id) ON DELETE CASCADE,
    FOREIGN KEY(pickup_point_sys_user_id) REFERENCES sys_user(sys_user_id) ON DELETE CASCADE,
    #refers to farmer
